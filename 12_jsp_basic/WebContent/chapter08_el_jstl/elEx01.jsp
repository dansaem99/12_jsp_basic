...
<body>
	...
	<%--   
		...
		# EL (Expression Language)
			...
			${sessionScope.}	  : 세션 Scope에 접근 o
			${pageScope.}		  : 페이지 Scope에 접근
			${requestScope.} 	  : 리퀘스트 Scope에 접근 o
	...
	<h3> 자바의 변수 표기</h3>
	<p>${requestScope.name }</p> <!--requestScope. 은 생략가능하다  -->
	<p>${num1 }</p>
	<p>${num2 }</p>
	<hr>
	...
	<h3>배열형 데이터 타입</h3>
	<p>${list1 == null }</p>	<!-- 생성 X -->
	<p>${ empty list2 }</p>		<!-- 생성 O , 데이터 X -->
	<p>${not empty list3 }</p>	<!-- 생성 O , 데이터 O -->
