...
public class Upload2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String saveDirectory = "C:\\Users\\19-web-ksm\\git\\12_jsp_basic\\12_jsp_basic\\WebContent\\chapter09_file\\fileRepository";
		...
		String uploadDate = sdf.format(new Date()); // new Date() 현재 시간을 찍는다.
